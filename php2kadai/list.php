...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
    // 画像を取得
    $sql = 'SELECT * FROM product_images_table ORDER BY created_at DESC';
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        $sql = 'INSERT INTO product_images_table(image_name, image_type, image_content, image_size, created_at)
